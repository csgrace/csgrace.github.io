...
const i18n = {
  en: {
    ...
    "meituan.detail.takeaway.desc": "1. AI Agents in production ≠ demos. Real-world deployment requires robust evaluation, monitoring, and iteration loops. A single prompt template isn't enough—you need a system. 2. Data closes the loop. The evolution dashboard and KB evaluation suite turned agent optimization from \"gut feeling\" into a measurable, repeatable process. Every change was tracked and validated. 3. Memory is architecture, not storage. The Directory Tree + Progressive Loading pattern solved context overflow without losing information fidelity. Full memory addressable, context window lightweight.",
  },
